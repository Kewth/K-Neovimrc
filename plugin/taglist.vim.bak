...
function! s:Tlist_Window_Display_Help()
    ...
    if s:tlist_brief_help
        ...
        call append(0, '" <C-j> : Jump to tag definition')
...
function! s:Tlist_Window_Init()
    ...
    nnoremap <buffer> <silent> K :call  <SID>Tlist_Window_Move_To_File(-1)<CR>
    nnoremap <buffer> <silent> ]] :call <SID>Tlist_Window_Move_To_File(1)<CR>
    nnoremap <buffer> <silent> J :call  <SID>Tlist_Window_Move_To_File(1)<CR>
    ...
    inoremap <buffer> <silent> K    <C-o>:call <SID>Tlist_Window_Move_To_File(-1)<CR>
    inoremap <buffer> <silent> ]]   <C-o>:call <SID>Tlist_Window_Move_To_File(1)<CR>
    inoremap <buffer> <silent> J    <C-o>:call <SID>Tlist_Window_Move_To_File(1)<CR>
